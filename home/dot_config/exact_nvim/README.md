...
2. Built-in mappings belong in the corresponding interface's plugin spec.
   - Use `init` for built-in options or mappings that must be set before or independently of plugin setup.
3. Plugin-specific mappings should live on the corresponding plugin spec whenever possible.
